...
import com.netmillennium.gagrid.cache.GeneCacheConfig;
...
public class GAGrid {
    ...
    List<Long> getPopulationKeys() {
     ...
     IgniteCache getGeneCache()
    {
    	return geneCache;
    }
    
    IgniteCache getPopulationCache()
    {
    	return populationCache;
    }
    
    public GAConfiguration getGAGridConfiguration()
    {
      return cfg;	
    }
